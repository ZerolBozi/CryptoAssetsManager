...
class Upbit(BaseExchange):
    ...
    def get_quote_markets(self) -> list:
        ...
        self.quote_markets = [
            item['market'] for item in self.markets 
            if item['market'].startswith('KRW') and self.except_symbol not in item['market']
        ]
...
class Binance(USDTExchange):
    ...
    def _get_markets(self):
        ...
        self.quote_markets = [
            item['symbol'] for item in self.markets 
...
class OKX(USDTExchange):
    ...
    def _get_markets(self):
        ...
        self.markets = response.json()
        self.quote_markets = [
            item['instId'] for item in self.markets['data'] 
...
class Bybit(USDTExchange):
    ...
    def _get_markets(self):
        ...
        self.markets = response.json()
        self.quote_markets = [
            item['symbol'] for item in self.markets['result']["list"] 
...
class Bitget(USDTExchange):
    ...
    def _get_markets(self):
        ...
        self.markets = response.json()
        self.quote_markets = [
            item['symbol'] for item in self.markets['data'] 
            if item["quoteCoin"] == "USDT"
        ]
...
class MEXC(USDTExchange):
    ...
    def _get_markets(self):
        ...
        self.markets = response.json()
        self.quote_markets = [
            symbol["symbol"] for symbol in self.markets["symbols"] 
...
class Gate(USDTExchange):
    ...
    def _get_markets(self):
        ...
        self.markets = response.json()
        self.quote_markets = [
            item["id"] for item in self.markets 
